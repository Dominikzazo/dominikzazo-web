  ...
  return (
    <TweakRow label={label}>
      ...
      className={dragging ? 'twk-seg dragging' : 'twk-seg'}>
        ...
        {opts.map((o) =>
        <button key={o.value} type="button" role="radio" aria-checked={o.value === value} style={{color: "rgb(0, 0, 0)"}}>
            {o.label}
          </button>
        )}
      </div>
...
function TweakColor({ label, value, onChange }) {
  return (
    <div className="twk-row twk-row-h">
      ...
      onChange={(e) => onChange(e.target.value)} style={{ borderColor: "rgb(255, 0, 0)" }} />
    </div>);
